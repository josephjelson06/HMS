...
export const hotelReportsApi = {
  ...
  export: (code: string, payload: ReportExportRequest) =>
    apiFetch<ReportExport>(`/hotel/reports/${code}/export`, {
      method: "POST",
      body: JSON.stringify(payload)
    }),
  getExport: (exportId: string) =>
    apiFetch<ReportExport>(`/hotel/reports/exports/${exportId}`)
};
